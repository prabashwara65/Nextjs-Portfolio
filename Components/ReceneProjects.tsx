    ...
    <div className='py-20' id='projects'>
      ...
      <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10'>
        {projects.map(({ id, title, des, img, iconLists ,link }) => (
          <div key={id} className=' sm:h-[41rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-96 w-[90vw]'>
            <PinContainer title={title} href={link}>
                {/* sm:w-[570px] */}
              <div className='flex items-center justify-center sm:w-[400px] w-[80vw] overflow-hidden sm:h-[40vh] h-[30vh] mb-10 relative'>
